...
Event.add({
	...
	theFooter: { type: Types.Markdown, label: 'Short Description', note: 'Shown in events grid page. Will be cut off at 150 characters.', max: {chars: 150, mode: 'validate'}, required: true, initial: true },
