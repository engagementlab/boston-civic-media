...
Event.add({
	...
	description: { type: Types.Textarea, label: 'Long Description', note: 'Shown on individual event page. No character limit.', required: true, initial: true },
	footer: { type: Types.Textarea, label: 'Short Description', note: 'Shown in events grid page. Will be cut off at 150 characters.', max: {chars: 150, mode: 'validate'}, required: true, initial: true },
