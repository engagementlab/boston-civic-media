...
if($background){
    ...
    $data = trim($data);
    if ($type == 'p3' || $type == 'p')
        return '<p><img src="//chart.apis.google.com/chart?chxs=0,555555,11.5&chxt=x&chs=' . $width . 'x' . $height . '&cht=' . $type . '&#038;chtt=' . $title . '&#038;chl=' . $label . '&#038;chco=' . $colors . '&#038;chs=' . $width . 'x' . $height . '&#038;chd=t:' . $data . '&chdl=' . $legend . '&#038;chf=bg,s,'. $background . '" alt="' . $title . '"  /></p>';
    elseif ($type == 'lc')
        return '<p><img src="//chart.apis.google.com/chart?chs=' . $width . 'x' . $height . '&chf=bg,s,'. $background . '&chl=' . $label . '&cht=lc&chco=' . $colors . '&chd=t:' . $data . '&chdlp=b&chg=4,1,0,5&chls=1&chma=|0,10&chtt=' . $title . '&chts=676767,13.5" width="' . $width . '" height="' . $height . '" alt="' . $title . '" /></p>';
    elseif ($type == 'bvg')
        return '<p><img src="//chart.apis.google.com/chart?chbh=a&chs=' . $width . 'x' . $height . '&chf=bg,s,'. $background . '&cht=bvs&chco=' . $colors . '&chd=t:' . $data . '&chdl=' . $legend . '&chdlp=b&chg=4,1,0,5&chma=|0,10&chtt=' . $title . '&chts=676767,13.5" width="' . $width . '" height="' . $height . '" alt="' . $title . '" /></p>';
    else
        return '<p><img src="//chart.apis.google.com/chart?chxs=0,555555,11.5&chxt=x&chs=' . $width . 'x' . $height . '&cht=' . $type . '&#038;chtt=' . $title . '&#038;chl=' . $label . '&#038;chco=' . $colors . '&#038;chs=' . $width . 'x' . $height . '&#038;chd=t:' . $data . '&chdl=' . $legend . '&#038;chf=bg,s,'. $background . '" alt="' . $title . '"  /></p>';
}
...
$atts = array(
    ...
    'options' => array(
        ...
        array(
            ...
            'value' => __('The most popularity internet browser','tfuse'),
            'type' => 'text'
        ),
        array(
            'name' => __('Data','tfuse'),
