...
function tfuse_frame($atts, $content = null)
{
    ...
    if ($prettyphoto == 'true')
        return '<a href="' . $src . '" target="' . $target . '" rel="prettyPhoto" ><span class="preload"><img class="frame_' . $align . '" src="' . $src . '"  width="' . $width . '" height="' . $height . '" alt="' . $alt . '" /></span></a>';
    else
...
$atts = array(
    ...
    'options' => array(
        ...
        array(
            ...
            'id' => 'tf_shc_frame_alt',
            'value' => __('Premium Wordpress Themes','tfuse'),
            'type' => 'text'
        ),
        array(
            'name' => __('Align','tfuse'),
