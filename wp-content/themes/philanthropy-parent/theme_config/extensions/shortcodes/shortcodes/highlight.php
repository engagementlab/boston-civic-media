    ...
    'options' => array(
        array(
            ...
            'desc' => __('Specify classes of the shortcode
                <br /><b>predefined classes:</b> highlight-primary, highlight-brown, highlight-info, highlight-danger, highlight-warning ...','tfuse'),
        ...
        array(
            'name' => __('Style','tfuse'),
            'desc' => __('Specify an inline style for the shortcode','tfuse').' <br /> e.g. color:#ffffff; background:#cc1d00',
