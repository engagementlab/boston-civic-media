...
class TF_INTERFACE extends TF_TFUSE
{
    ...
    public function admin_add_js()
    {
        ...
        $allow_enqueue = $this->include->pass_visibility_rules(array(
        ...
        wp_register_script('TFE', get_template_directory_uri() . '/framework/static/javascript/TFE.js', array('jquery'), '1.0');
        if ($allow_enqueue) {
