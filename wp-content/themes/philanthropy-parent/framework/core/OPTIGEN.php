...
class TF_OPTIGEN extends TF_TFUSE
{
    ...
    function multi($opts)
    {
        ...
        $output .= '<input type="text" id="' . $opts['id'] . '_entries" name="' . $opts['id'] . '_entries" class="tfuse_suggest_input tfuse_' . $type . '_type tfuse_input_help_text" rel="' . esc_attr($opts['subtype']) . '" data-limit="' . $limit . '" value="' . esc_attr( __('Type here to search', 'tfuse') ) . '" />';
