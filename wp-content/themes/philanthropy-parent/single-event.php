        ...
        <?php endif; ?> 
                <div class="inner">
                    ...
                    <section class="projects-details-navigation clearfix">
                        <span class="prev_pag"><?php previous_post_link( '%link','<i class="icon-chevron-left"></i><span>'.__('Previous Event','tfuse').'</span>' ); ?></span>
                        <span class="next_pag"><?php next_post_link( '%link', '<span>'.__('Next Event','tfuse').'</span><i class="icon-chevron-right"></i>' ); ?></span>
                    </section>
